...
function BrandGlyph({ id }: { id: "whatsapp" | "viber" | "wechat" | "email" }) {
  ...
  const paths = {
    ...
    email:
      "M1.5 4.5A2.5 2.5 0 014 2h16a2.5 2.5 0 012.5 2.5v15A2.5 2.5 0 0120 22H4a2.5 2.5 0 01-2.5-2.5v-15zm2.08.5 7.66 5.1a1.5 1.5 0 001.52 0L20.42 5H3.58zm17.92 1.72-7.4 4.93a3.5 3.5 0 01-3.2 0L3.5 7.22V19.5A.5.5 0 004 20h16a.5.5 0 00.5-.5V7.22z",
  };
  return (
    <span className={`flex h-12 w-12 items-center justify-center rounded-full text-snow shadow-lg ${colors[id]}`}>
