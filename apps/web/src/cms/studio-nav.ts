...
export function studioNav(admin: string): StudioNavItem[] {
  return [
    ...
    { href: `/${admin}/treks`, label: "Trips", hint: "All trip kinds — treks, rafting, activities, safaris", tint: "bg-sky/15 text-sky" },
    { href: `/${admin}/rides`, label: "Rides", hint: "Motorcycle packages and the /rides page", tint: "bg-gold/20 text-ink" },
