...
export const PAGE_CATALOG: CopyGroup[] = [
  ...
  },
  {
    ...
    fields: [
      ...
      short("featured.rideKicker", "Rides page — small line"),
      short("featured.rideTitle", "Rides page — title"),
      short("featured.allRides", "All rides link"),
      long("featured.rideLede", "Rides page — intro"),
    ],
  },
  {
    id: "about",
  ...
  },
  {
    ...
    fields: [
      ...
      short("plan.rideTitle", "Rides section title"),
      long("plan.rideLede", "Rides section intro"),
