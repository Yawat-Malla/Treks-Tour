...
export const PAGE_CATALOG: CopyGroup[] = [
  ...
  },
  {
    ...
    fields: [
      ...
      short("heroTabs.rides", "Rides card"),
  ...
  },
  {
    ...
    help: "The titles at the top of Treks, Rafting, Activities, Safaris, and Rides.",
    fields: [
  ...
  },
  {
    id: "rides",
    label: "Rides page",
    help: "Listing banner words on /rides, the homepage ride band, Plan-page ride copy, and the hero tab label. The banner photo is edited under Studio → Rides.",
    fields: [
      short("featured.rideKicker", "/rides — small line"),
      short("featured.rideTitle", "/rides — title"),
      long("featured.rideLede", "/rides — intro"),
      short("featured.allRides", "All rides link (homepage)"),
      short("featured.homeRideKicker", "Homepage ride band — small line"),
      short("featured.homeRideTitle", "Homepage ride band — title"),
      long("featured.homeRideLede", "Homepage ride band — intro (optional)"),
      short("plan.rideTitle", "Plan page — rides section title"),
      long("plan.rideLede", "Plan page — rides section intro"),
      short("heroTabs.rides", "Homepage hero — Rides card"),
    ],
  },
  {
    id: "about",
  ...
  },
  {
    id: "plan",
    label: "Plan a trip",
    help: "The Plan page that lists treks, rivers, activities, safaris, and rides.",
    fields: [
